  ...
  return (
    <>
        <div id="footer" className='w-full h-auto lg:h-screen text-white flex sm:flex flex-col justify-center items-center'>
            <div id="first-section" className='w-[100%] h-[20vh] md:h-auto xl:h-[45vh]'>
            ...
            <div id="second-section" className='w-[100%] lg:h-[10vh] md:h-[calc(30vh+2)] xl:h-[30vh] h-[30vh] flex justify-center items-center'>
            ...
            <div id="third-section" className='w-[100%] h-[20vh] md:h-[calc(20vh+2)] lg:h-[20vh] flex flex-col sm:flex-row justify-center items-center gap-8 sm:gap-0'>
