...
export default function Hero() {
  ...
  return (
    <>
        <div id="hero-sec" className='w-full h-screen flex flex-col-reverse sm:flex-row justify-center items-center relative' onContextMenu={(e) => e.preventDefault()}>
            ...
            <div id="right" className='w-full sm:w-1/2 h-[40vh] sm:h-[80vh] flex justify-center items-center relative select-none pointer-events-none'>
