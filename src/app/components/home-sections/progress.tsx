...
function Progress_sec({ name, indexs }: ProgressSecProps) {
  return (
    <>
        <div id="area" className='w-full md:w-[80%] lg:w-full xl:w-[80%] h-[15vh] flex flex-col justify-center items-center relative gap-4 md:gap-10 bg-[#fff]/80'>
            <div id="inner_area" className='w-[80%] h-[100%] flex flex-col justify-center items-center relative gap-4 md:gap-10'>
